...
const CreateCategoryForm = () => {
    ...
    useEffect(() => {
        ...
        setIsAdmin(userDetails && userDetails.userType === 'Admin');
    }, []);
    ...
    //  error message if not an admin
    if (!isAdmin) {
        return (
            <div className="mt-20  min-h-screen flex items-center justify-center text-red-500 font-bold">
                Only Admin is allowed
            </div>
        );
    }

    // form for admin users
    return (

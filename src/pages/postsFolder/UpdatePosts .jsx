...
const UpdatePosts = ({ postId }) => {
  ...
  useEffect(() => {
    const fetchPost = async () => {
      try {
        ...
        const { title, content, category, tags, imageUrl } = response.data.post;
  ...
  const updatePost = async (event) => {
    ...
    try {
      ...
      // Redirect or perform any other actions after updating the post
    } catch (error) {

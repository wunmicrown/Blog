            ...
            <div className="boxs" key={item.id}>
              <div className="box relative">
                ...
                <div className="overlay absolute top-0 left-0 right-0 bottom-0 flex flex-col items-center justify-center bg-black bg-opacity-55 text-white">
                  ...
                  <p className="absolute top-0 left-0 right-0 bottom-0 flex flex-col items-center justify-center bg-black bg-opacity-35 text-white transition-colors duration-500 hover:bg-opacity-55">
                    {item.title}
                  </p>
                </div>
              </div>

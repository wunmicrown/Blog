  ...
  useEffect(() => {
    const fetchPostsByCategory = async (categoryName) => {
      ...
      try {
        ...
        console.log("latestPosts", data.latestPosts)
        console.log("trendingPosts", data.trendingPosts)
    ...
    <>
      ...
      <div className="container relative z-10 px-4 mx-auto">
        ...
        <div className="container px-4 mx-auto">
            ...
            <span className="inline-block py-px px-2 mb-8 text-xs leading-5 text-green-500 bg-green-100 font-medium uppercase rounded-full shadow-sm">
                Blog
              </span>

              <h3 className="mb-14 text-2xl text-center md:text-3xl leading-tight text-darkCoolGray-900 font-bold tracking-tighter">
                Read our Trending Articles
              </h3>
            </div>
            <div className="flex flex-wrap mx-4 mb-8 md:mb-16">
              {/* Handle loading, error, and no posts found */}
              {loading ? (
          ...
          <div>
            <div className="md:max-w-5xl mx-auto mb-10 md:mb-16 text-center">
              <h3 className="mb-4 text-2xl md:text-3xl leading-tight text-darkCoolGray-900 font-bold tracking-tighter">

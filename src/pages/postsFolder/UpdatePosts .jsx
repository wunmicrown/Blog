...
const UpdatePosts = () => {
    ...
    const handleFileChange = (event) => {
        ...
        console.log("handleFileChange ", setCoverImgUrl(selectedFile))
    ...
    const updatePost = async (event, status) => {
        ...
        if (coverImgUrl) {
            formData.append('image', coverImgUrl); // Corrected here
        }
...
//         formData.append('category', post.category);
//         if (coverImgUrl) {
//             formData.append('image', post.coverImgUrl);
//         }
//         formData.append('tags', post.tags.join(','));
//         formData.append('status', status);
...
//             if (status === 'draft') {
//                 toast.success("Post saved as draft !!");
//                 navigate(`/${data.postUpdted.author}/drafts`);
//             } else {
//                 toast.success("Post updated and published !!");
//             }
